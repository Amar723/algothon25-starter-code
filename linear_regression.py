...
#     price_data = np.loadtxt('prices.txt', delimiter=',')  # adjust delimiter if needed
#     # Access price of instrument 10 on day 200
#     price = price_data[10, 200]
#     positions = getMyPosition(price_data)
